    ...
    <div class="service-body">
      <template v-if="formFields.length">
        <div v-for="(field, index) in formFields" :key="index" class="form-group">
          ...
          <input v-if="field.type === 'input'" :id="field.name" type="text" :placeholder="field.placeholder" v-model="field.value">
          <textarea v-else-if="field.type === 'textarea'" :id="field.name" type="text" :placeholder="field.placeholder" v-model="field.value" />
